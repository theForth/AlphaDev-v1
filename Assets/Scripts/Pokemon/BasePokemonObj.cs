...
{         //*****AnimatorVariables*************** 
    ...
    private Dictionary<int, Action<Transform, PokemonObj>> currentMoveMethods = new Dictionary<int, Action<Transform, PokemonObj>>();
    ...
    void Start()
    {
        ...
        //}
        currentMoveMethods.Add(85, MoveMethodManager.MoveMethods[85]);
        currentMoveMethods.Add(45, MoveMethodManager.MoveMethods[45]);
    ...
    void Update()
    {
        foreach (MoveData move in pokemon.moves)
        {
    ...
    public void CastMove(int selectedMoveIndex)
        {
            currentMoveMethods[moves[selectedMoveIndex].Id](transform,this);
        }
