...
public class PokemonController : MonoBehaviour
{
    //********************Movement*************************************************
        ...
        public MovementControlState movementControlState = MovementControlState.PlayerControl;
		//private PlayerAnimatorController _animator;
	//*********************************************************************************************

    //**********************************SkillListener*********************************************
      public static int selectedMoveIndex = 0;
      private PokeBattler pokeBattler;
		...
		void Start ()
		{
                ...
                pokeBattler = GetComponent<PokeBattler>();
		...
		*/
        ...
        void MovePokemon()
        {
            ...
            if (_grounded)
            {
                ...
                {
                    ani.SetFloat(HashIDs.speedFloat, 1.5f, 0.5f, Time.deltaTime);
                }
                else
                {
                    ani.SetFloat(HashIDs.speedFloat, 0, 0.05f, Time.deltaTime);
                }
                /*if (_move_speed > 0) {
