...
namespace Apex.PathFinding
{
    ...
    public class PathingAStar : PathingEngineBase
    {
        ...
        public PathingAStar(int heapInitialSize, bool cutCorners)
        ...
        public PathingAStar(int heapInitialSize, bool cutCorners, IMoveCost moveCostProvider, ISmoothPaths pathSmoother)
        ...
        /// <summary>
        /// Gets a value indicating whether to cut corners.
        /// </summary>
        /// <value>
        ///   <c>true</c> to cut corners; otherwise, <c>false</c>.
        /// </value>
        protected bool cutCorners
        {
            get { return _cutCorners; }
        }
