...
namespace Apex.PathFinding
{
    ...
    public sealed class PathServiceComponent : SingleInstanceComponent<PathServiceComponent>
    {
        ...
        /// <summary>
        /// Whether to allow the path to cut corners. Corner cutting has slightly better performance, but produces less natural routes.
        /// </summary>
        ...
        protected sealed override void OnAwake()
        {
            ...
            {
                engine = new PathingAStar(this.initialHeapSize, this.cutCorners, moveCostProvider, pathSmoother);
            }
            else
            {
                engine = new PathingJumpPointSearch(this.initialHeapSize, this.cutCorners, moveCostProvider, pathSmoother);
            }
