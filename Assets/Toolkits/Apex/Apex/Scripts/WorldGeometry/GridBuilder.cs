...
namespace Apex.WorldGeometry
{
    ...
    public class GridBuilder : ICellMatrixConfiguration
    {
        ...
        /// </summary>
        /// <param name="updateHeightData">if set to <c>true</c> height map data will be included.</param>
        /// <returns>The grid configuration</returns>
        public IGrid Create(bool updateHeightData)
        {
            var cellMatrix = CellMatrix.Create(this, updateHeightData);
