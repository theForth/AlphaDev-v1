...
namespace Apex.WorldGeometry
{
    ...
    public class CellMatrix : Matrix<Cell>, IHeightMap
    {
        ...
        private IList<PortalCell> _portals;
        ...
        internal IList<PortalCell> portals
        {
            get { return _portals; }
        }
        ...
        /// <param name="updateHeightData">if set to <c>true</c> height data will be included.</param>
        /// <returns>The matrix</returns>
        public static CellMatrix Create(ICellMatrixConfiguration cfg, bool updateHeightData)
        {
            var matrix = new CellMatrix(cfg);

            var iter = matrix.Populate(updateHeightData);
            while (iter.MoveNext())
            {
        ...
        private void Initialize(ICellMatrixConfiguration cfg)
        {
            ...
            _portals = new List<PortalCell>();
        }

        private IEnumerator Populate(bool updateHeightData)
        {
            ...
            if (updateHeightData && this.hasHeightMap)
            {
