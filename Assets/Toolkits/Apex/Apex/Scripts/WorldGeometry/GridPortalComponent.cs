...
namespace Apex.WorldGeometry
{
    ...
    public class GridPortalComponent : ExtendedMonoBehaviour
    {
        ...
        /// </summary>
        public Bounds portalOne = new Bounds(new Vector3(-3f, 0f, -3f), new Vector3(1f, 0.2f, 1f));

        /// <summary>
        /// The bounds of the second portal
        /// </summary>
        public Bounds portalTwo = new Bounds(new Vector3(3f, 0f, -3f), new Vector3(1f, 0.2f, 1f));
        ...
        private void Awake()
        {
            ...
            try
            {
                _portal = GridPortal.Create(this.portalName, this.portalOne, this.portalTwo, this.exclusiveTo, action);
            }
            catch (Exception e)
            {
