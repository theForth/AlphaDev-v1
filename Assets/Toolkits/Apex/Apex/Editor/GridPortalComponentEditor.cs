namespace Apex.Editor
{
    ...
    public class GridPortalComponentEditor : AttributeMaskedEditorBase
    {
        ...
        {
            _lastPosition = (this.target as GridPortalComponent).transform.position;
        }
        ...
        protected override void ContinueGUI()
        {
            ...
            owner.exclusiveTo = GetValue(owner.exclusiveTo, "Exclusive To");
