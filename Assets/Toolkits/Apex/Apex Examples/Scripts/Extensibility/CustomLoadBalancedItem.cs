namespace Apex.Examples.Extensibility
{
    ...
    /// <summary>
    /// A custom load balanced item, that could be added to the <see cref="CustomLoadBalancer"/>, by CustomLoadBalancer.extraLoadBalancer.Add(new CustomLoadBalancedItem()) or one of the overloads.
    /// </summary>
